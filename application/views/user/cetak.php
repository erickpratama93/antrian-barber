...
<link href="<?php echo base_url('assets/user')?>/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  ...
  <link href="<?php echo base_url('assets/user')?>/lib/themes/metroui.css" rel="stylesheet">
	  ...
	  <ul class="list-group list-group-flush">
	    <li class="list-group-item text-center"><h3>SELAMAT DATANG</h3><h5>di D`Kriwoel Barbershop</h5>
	    	<h8>Jl. Supriyadi, Gg. Merpati
            <br>Kademangan, Bondowoso</h8>
		</li>
	    <li class="list-group-item text-center">
	    	<div class="row card-link"><?php echo $row->tgl_antrian_barberman ?></div>
	    	<h4>ANTRIAN</h4><h1><?php echo $row->no_antrian_barberman ?></h1><h6><?php echo $row->nama_barberman ?></h6>
	    </li>
