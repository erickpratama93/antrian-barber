...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container" style="margin-top: 0px;">
      <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="<?php echo base_url('assets/user')?>/img/logo.png" alt=""  width="50">Antrian D`Kriwoel Barbershop</a>
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="row" style="margin-top: -80px; margin-left: 180px;">
      ...
      <!-- <div class="col-md-4" style="padding-top: 30px;"><h1>D`Kriwoel Barbershop</h1></div> -->
    </div>
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small>&copy; Antrian D`Kriwoel Barbershop 2022 </small>
    </div>
  </section>
